...
func (ExecutionStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (ProtoItem_ItemType) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{1, 0} }
...
func (Fragment_FragmentType) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{8, 0} }
...
func (Parameter_ParameterType) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{9, 0} }
...
func (Error_ErrorType) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{18, 0} }
...
func (*ProtoSpec) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*ProtoItem) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*ProtoScenario) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (*Span) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func (*ProtoTableDrivenScenario) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{4} }
...
func (*ProtoStep) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{5} }
...
func (*ProtoConcept) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{6} }
...
func (*ProtoTags) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{7} }
...
func (*Fragment) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{8} }
...
func (*Parameter) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{9} }
...
func (*ProtoComment) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{10} }
...
func (*ProtoTable) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{11} }
...
func (*ProtoTableRow) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{12} }
...
func (*ProtoStepExecutionResult) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{13} }
...
func (*ProtoExecutionResult) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{14} }
...
func (*ProtoHookFailure) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{15} }
...
func (*ProtoSuiteResult) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{16} }
...
func (*ProtoSpecResult) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{17} }
...
func (*Error) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{18} }
...
func (*ProtoStepValue) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{19} }
...
func init() { proto.RegisterFile("spec.proto", fileDescriptor1) }
